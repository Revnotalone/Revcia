...
lagi:
clear();
echo color("yellow"," PERINGATAN ! ! !\n");
echo color("red"," HANYA UNTUK LELUCON !\n");
sleep(5);
clear();
...
___  __ \__  ____/_ |  / /_  ____/___  _/__    |__    |
__  /_/ /_  __/  __ | / /_  /     __  / __  /| |_  /| |
_  _, _/_  /___  __ |/ / / /___  __/ /  _  ___ |  ___ |
/_/ |_| /_____/  _____/  \____/  /___/  /_/  |_/_/  |_|
...
if ($aaa1 == 3) {
  clear();
  $url = "https://github.com/Revnotalone/Revcia/blob/main/donasi.jpg";
